...
DELIMITER /*!*/;
# at 4
#260414 13:39:33 server id 1  end_log_pos 126 CRC32 0x5c2075b0 	Start: binlog v 4, server v 8.0.43-0ubuntu0.24.04.1 created 260414 13:39:33
# at 126
#260414 13:39:33 server id 1  end_log_pos 157 CRC32 0x8fb79368 	Previous-GTIDs
# [empty]
# at 157
#260414 13:53:22 server id 1  end_log_pos 236 CRC32 0xd8128bc0 	Anonymous_GTID	last_committed=0	sequence_number=1	rbr_only=yes	original_committed_timestamp=1776167602175096	immediate_commit_timestamp=1776167602175096	transaction_length=334
/*!50718 SET TRANSACTION ISOLATION LEVEL READ COMMITTED*//*!*/;
# original_commit_timestamp=1776167602175096 (2026-04-14 13:53:22.175096 CEST)
# immediate_commit_timestamp=1776167602175096 (2026-04-14 13:53:22.175096 CEST)
/*!80001 SET @@session.original_commit_timestamp=1776167602175096*//*!*/;
/*!80014 SET @@session.original_server_version=80043*//*!*/;
/*!80014 SET @@session.immediate_server_version=80043*//*!*/;
SET @@SESSION.GTID_NEXT= 'ANONYMOUS'/*!*/;
# at 236
#260414 13:53:22 server id 1  end_log_pos 323 CRC32 0x0b1347cb 	Query	thread_id=27	exec_time=0	error_code=0
SET TIMESTAMP=1776167602/*!*/;
SET @@session.pseudo_thread_id=27/*!*/;
SET @@session.foreign_key_checks=1, @@session.sql_auto_is_null=0, @@session.unique_checks=1, @@session.autocommit=1/*!*/;
SET @@session.sql_mode=1168113696/*!*/;
SET @@session.auto_increment_increment=1, @@session.auto_increment_offset=1/*!*/;
...
/*!*/;
# at 323
#260414 13:53:22 server id 1  end_log_pos 406 CRC32 0x7781d1dc 	Table_map: `empresa_segura`.`empleados` mapped to number 115
# has_generated_invisible_primary_key=0
# at 406
#260414 13:53:22 server id 1  end_log_pos 460 CRC32 0xbbc29226 	Write_rows: table id 115 flags: STMT_END_F
### INSERT INTO `empresa_segura`.`empleados`
### SET
###   @1=6
###   @2='Marta'
...
###   @6=NULL
# at 460
#260414 13:53:22 server id 1  end_log_pos 491 CRC32 0x0949ed0f 	Xid = 409300
COMMIT/*!*/;
# at 491
#260414 13:53:24 server id 1  end_log_pos 535 CRC32 0xd6b36331 	Rotate to binlog.000234  pos: 4
SET @@SESSION.GTID_NEXT= 'AUTOMATIC' /* added by mysqlbinlog */ /*!*/;
DELIMITER ;
# End of log file
/*!50003 SET COMPLETION_TYPE=@OLD_COMPLETION_TYPE*/;
